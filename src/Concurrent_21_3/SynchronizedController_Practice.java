...
public class SynchronizedController_Practice extends Practice_1{
	
	public synchronized void init(String str1,String str2,int id){
	...
	private synchronized void setPractice_1(String str1,String str2,int id){
		setPractice_2(str1,str2,id);
	}
	
	private synchronized void setPractice_2(String str1,String str2,int id){
		setTitle(str1);
		setAnswer(str2);
	...
	public static void main(String[] args) {
		ThreadPractice.test(new SynchronizedController_Practice());
	}
